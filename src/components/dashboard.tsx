...
export default function Dashboard() {
  ...
  const [frontendSkills, setFrontendSkills] = useState(92)
  const [backendSkills, setBackendSkills] = useState(78)
  const [devOpsSkills, setDevOpsSkills] = useState(65)
  ...
  useEffect(() => {
    const interval = setInterval(() => {
      setFrontendSkills(Math.floor(Math.random() * 30) + 60)
      setBackendSkills(Math.floor(Math.random() * 20) + 60)
      setDevOpsSkills(Math.floor(Math.random() * 15) + 60)
      setSkillsLevel(Math.floor(Math.random() * 10) + 80)
    }, 3000)
                ...
                <CardContent className="p-0">
                  <div className="bg-gradient-to-br from-slate-800 to-slate-900 p-6 border-b border-slate-700/50">
                    <div className="text-center">
                      ...
                      <div className="text-3xl font-mono text-cyan-400 mb-1">John Doe</div>
                  ...
                  <div className="p-4">
                    <div className="grid grid-cols-2 gap-3">
                      <div className="bg-slate-800/50 rounded-md p-3 border border-slate-700/50">
                        ...
                        <div className="text-sm font-mono text-slate-200">San Francisco, CA</div>
                      </div>
                      <div className="bg-slate-800/50 rounded-md p-3 border border-slate-700/50">
                        <div className="text-xs text-slate-500 mb-1">Experience</div>
                        <div className="text-sm font-mono text-slate-200">7+ Years</div>
                      </div>
                    </div>
                  </div>
                </CardContent>
